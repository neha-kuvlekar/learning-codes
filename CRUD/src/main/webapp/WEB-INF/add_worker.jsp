...
<%@include file="./baseforstyling.jsp" %></head>
  ...
  <div class= "container mt-5">
  	<h3 class ="text-center">Add Worker Form</h3>
<!--    <form action="/processform" > absolute path
 -->      <form action="handle-product" method="post">
   
    <div class="form-group">
    <label for="TaskId">TaskId</label>
    <input type="text" class="form-control" id="TaskId" name="TaskId" aria-describedby="emailHelp" placeholder="Enter TaskId">
  </div>
   <div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class= "container mt-5">
  <a href="${pageContext.request.contextPath}/" class="btn outline-danger">Back</a>
<%--     <a href="editform.jsp?id=${TaskId}" class="btn outline-danger">View</a>
 --%>  
